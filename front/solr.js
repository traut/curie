...
Client.prototype.post = function(postPath, data, asJson, callback) {
    var contentType = (asJson) ? "application/json" : "text/xml";
...
Client.prototype.update = function(data, callback) {
    this.post("update", data, false, callback);
};

Client.prototype.updateJson = function(data, callback) {
    this.post("update", data, true, callback);
};
